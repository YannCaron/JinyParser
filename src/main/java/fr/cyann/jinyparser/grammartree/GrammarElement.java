...
/**
 * The GrammarElement class. Then top abstract class of all grammar
 * elements.<br>
 * Based on Interpreter / Composite GoF design pattern. <br>
 * Give the ability to declare (declarative programming) the language grammar by
 * nesting grammars elements together.
 */
...
public abstract class GrammarElement implements TreeIterable<GrammarElement> {
     ...
     *
     * @param context the parsing context that contains all necessary resources
     * to the parsing (iterators, flags and so on).
    ...
    public Iterable<GrammarElement> depthFirstTraversal(final PruningStrategy<GrammarElement> pruningStrategy) {
        return new Iterable<GrammarElement>() {
            @Override
            public Iterator<GrammarElement> iterator() {
                return new DepthFirstIterator<>(GrammarElement.this, pruningStrategy);
            }
        };
    }
    ...
    public Iterable<GrammarElement> breadthFirstTraversal(final PruningStrategy<GrammarElement> pruningStrategy) {
        return new Iterable<GrammarElement>() {
            @Override
            public Iterator<GrammarElement> iterator() {
                return new BreadthFirstIterator<>(GrammarElement.this, pruningStrategy);
            }
        };
    }
