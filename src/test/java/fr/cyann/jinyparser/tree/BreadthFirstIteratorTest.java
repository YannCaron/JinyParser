...
public class BreadthFirstIteratorTest extends TestCase {
    ...
    public void testIterator() throws Exception {
        ...
        for (Object g : g0.breadthFirstTraversal(new NoPruning())) {
            result.add((GrammarElement) g); // TODO : Iterator type problem !!!!
        }

        System.out.println(result);
        assertEquals(Arrays.asList(g0, g1, g21, g22, g31, g32, g33), result);
